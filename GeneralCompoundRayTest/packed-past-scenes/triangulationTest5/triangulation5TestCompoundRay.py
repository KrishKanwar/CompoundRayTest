...
if not os.path.exists("TriangulationTests/triangulation5Test/test-videos"):
    os.mkdir("TriangulationTests/triangulation5Test/test-videos")
...
try:
    ...
    eyeRenderer.loadGlTFscene(c_char_p(bytes(os.path.expanduser("~/Documents/GitHub/CompoundRayTests/TriangulationTests/triangulation5Test/triangulation5-test.gltf"), 'utf-8')))
    ...
    for i in range(2):
        ...
        video_name = "TriangulationTests/triangulation5Test/test-videos/test-video-"+str(i)+".mp4"
