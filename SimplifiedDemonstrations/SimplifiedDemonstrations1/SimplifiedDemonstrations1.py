...
if not os.path.exists("SimplifiedDemonstrations/SimplifiedDemonstrations1/test-videos"):
    os.mkdir("SimplifiedDemonstrations/SimplifiedDemonstrations1/test-videos")
...
try:
    ...
    eyeRenderer.loadGlTFscene(c_char_p(bytes(os.path.expanduser("~/Documents/GitHub/CompoundRayTests/SimplifiedDemonstrations/SimplifiedDemonstrations1/SimplifiedDemonstrations1copy.gltf"), 'utf-8')))
    ...
    for i in range(2):
        ...
        video_name = "SimplifiedDemonstrations/SimplifiedDemonstrations1/test-videos/test-video-"+str(i)+".mp4"
