...
if not os.path.exists("TriangulationTests/triangulation3Test/test-videos"):
    os.mkdir("TriangulationTests/triangulation3Test/test-videos")
...
try:
    ...
    eyeRenderer.loadGlTFscene(c_char_p(bytes(os.path.expanduser("~/Documents/GitHub/CompoundRayTests/TriangulationTests/triangulation3Test/triangulation3-test.gltf"), 'utf-8')))
    ...
    for i in range(2):
        ...
        video_name = "TriangulationTests/triangulation3Test/test-videos/test-video-"+str(i)+".mp4"
